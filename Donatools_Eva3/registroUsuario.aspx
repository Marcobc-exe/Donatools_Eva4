    ...
    <main>
        <div class="box_form">
            ...
            <div class="panel_error">
                ...
                <asp:RequiredFieldValidator Display="Dynamic" ControltoValidate="dropGenero" runat="server" ErrorMessage="Genero Obligatorio </br>"  ForeColor="red"></asp:RequiredFieldValidator>
