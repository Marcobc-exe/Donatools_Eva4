...
{
    public partial class donacionComida : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (DonacionController.filterType(2) != null)
            {
                string html = "";
                foreach (Donacion donacion in DonacionController.filterType(2))
                {
